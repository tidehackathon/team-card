...
art_df = pd.read_csv("../resources/articles.csv", index_col=[0])
sputnik_df = pd.read_csv("../resources/sputnik_news_up.csv", encoding="cp1252")
...
print(articles_df)
articles_df.to_csv("../resources/all-articles.csv")
